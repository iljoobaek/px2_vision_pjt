        ...
        for(i = 1; i < argc; i++) {
            ...
            if(!strcasecmp(argv[i], "-h")) {
                ...
                if(argv[i + 1] && argv[i + 1][0] != '-') {
                    ...
                    return PARSE_FAILED_INVALID_PARAMS;
                }
        ...
        for(i = 1; i < argc; i++) {
            ...
            if(strcasecmp(&argv[i][1], "h") == 0) {
                ...
                if(bDataAvailable) {
                    ...
                    args->linksNum = EXTIMGDEV_MAP_COUNT_ENABLED_LINKS(args->camMap.enable);
                }
