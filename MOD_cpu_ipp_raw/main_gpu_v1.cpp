...
int main( int argc, char** argv )
{
    ...
    sleep(1);
    gpu::GpuMat prv_temp, prv_temp_cap, prv_temp_full;
    getImgBuffer(inputBuffer);
    prv_temp_cap.upload(matInputBuffer);
    ...
    while(true)
    {
        ...
        /* ***** START TIMING ***** */
        gpu::GpuMat next_temp, next_temp_cap, next_temp_full;
        getImgBuffer(inputBuffer);
        next_temp_cap.upload(matInputBuffer);
