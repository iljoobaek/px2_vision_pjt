...
int getImgBuffer(unsigned char* inputBuffer, unsigned int width, unsigned int height)
{
    FILE * pFile;
    //printf("in getImgBuffer\n");
    if (sockfd == 0){
    ...
    //while(1){
        ...
        int recv_len = recv(forClientSockfd,inputBuffer,4746240*4,MSG_WAITALL);//width*height,0);
