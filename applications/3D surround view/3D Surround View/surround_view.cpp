...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	cv::Mat matInputBuffer1(HEIGHT,WIDTH,CV_8UC4);			
	unsigned char* inputBuffer1 = matInputBuffer1.data;
	cv::Mat matInputBuffer2(HEIGHT,WIDTH,CV_8UC4);			
	unsigned char* inputBuffer2 = matInputBuffer2.data;
	cv::Mat matInputBuffer3(HEIGHT,WIDTH,CV_8UC4);			
	...
	do{
		...
		if (video_demo && !px2) {
            ...
            */
			...
			cvtColor(matInputBuffer, temp, CV_RGBA2BGR);
			cvtColor(matInputBuffer1, temp1, CV_RGBA2BGR);
			cvtColor(matInputBuffer2, temp2, CV_RGBA2BGR);
			cvtColor(matInputBuffer3, temp3, CV_RGBA2BGR);


			Texture1 = ConvertIplToTexture(temp, 1);
			Texture2 = ConvertIplToTexture(temp1, 2);
			Texture3 = ConvertIplToTexture(temp2, 3);
			Texture4 = ConvertIplToTexture(temp3, 4);
			//cv::Mat temp_re;
