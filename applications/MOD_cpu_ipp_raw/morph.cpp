...
static int log_level = LOG_MSG;
/*height and width of the rectangular window*/
#define heightrect 64
#define widthrect 96

Rect frame1(0,0,640,360);
Rect frame3(0,360,640,360);
Rect frame2(640,0,640,360);
Rect frame4(640,360,640,360);
...
#endif
#if 0
Rect rects1(40,  50, 120, 220);
Rect rects2(200, 50, 240, 260);
Rect rects3(480, 50, 120, 220);

Rect rects4(680, 50, 120, 220);
Rect rects5(840, 50, 240, 260);
Rect rects6(1120, 50, 120, 220);

Rect rects7(40, 410, 120, 220);
Rect rects8(200, 410, 240, 260);
Rect rects9(480, 410, 120, 220);

Rect rects10(680, 410, 120, 220);
Rect rects11(840, 410, 240, 260);
Rect rects12(1120, 410, 120, 220);
#endif

#if 1
Rect rects1(40,  10, 120, 220);
Rect rects2(200, 10, 240, 260);
Rect rects3(480, 10, 120, 220);

Rect rects4(680, 10, 120, 220);
Rect rects5(840, 10, 240, 260);
Rect rects6(1120, 10, 120, 220);

Rect rects7(40, 370, 120, 220);
Rect rects8(200, 370, 240, 260);
Rect rects9(480, 370, 120, 220);

Rect rects10(680, 370, 120, 220);
Rect rects11(840, 370, 240, 260);
Rect rects12(1120, 370, 120, 220);

#endif

int rectstat[RECTSTAT_SIZE];//Will use this to denote if it has a moving object or not
...
void FindBlobs(const Mat &binary,Mat &labels, vector < vector<Point2i> > &blobs)
{
    ...
    DBG("label_image rows: %d, cols: %d\n", label_image.rows, label_image.cols);
    ...
    if (perf_measure) {
        ...
        PERF("  -> time for blob loops: %0.2f ms\n", get_timediff(one, two));
    }
