...
#define debugimage 1
#define stop_early 1
#define stop_early_iterations 500
...
{
    cout << prv_temp.rows << " " << prv_temp.cols << endl;
    Size s = prv_temp.size();
    cout << prv_temp.type() << endl;
    ...
    */
    ...
    resize(test_bayer, prv, Size(2560,360));
    //cout << prv.type() << " " << prv.channels() << " " << prv.size() << endl;
...
//	}
    ...
    inputBuffer = (unsigned char*)malloc(4746240*4);
...
//processing start   
    ...
    */
    ...
    while(true)
    {
        ...
        getImgBuffer(inputBuffer, WIDTH, HEIGHT);
        //Mat a = imdecode((Mat)inputBuffer, 1);
        //imshow('a', a);
        //waitKey(0);
