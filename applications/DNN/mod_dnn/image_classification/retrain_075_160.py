...
def create_model_graph(model_info):
  ...
  with tf.Graph().as_default() as graph:
    model_path = '/home/gyan/mn_075_160.pb'
...
def create_model_info(architecture):
  ...
  if architecture == 'inception_v3':
    ...
    bottleneck_tensor_name = 'InceptionV3/Predictions/Reshape_1:0'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/home/gyan/test/train',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/home/gyan/test/output_075_160.pb',
