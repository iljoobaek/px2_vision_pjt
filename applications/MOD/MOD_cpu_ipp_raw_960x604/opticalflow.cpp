...
//Subtracted 360 from y coord
//Added 1280 to every x coord
Rect rect7(1300, 50, 185, 215);
Rect rect8(1485, 50, 230, 290);
Rect rect9(1715, 50, 185, 225);

Rect rect10(1940, 50, 185, 180);
Rect rect11(2125, 50, 230, 270);
Rect rect12(2355, 50, 185, 145);
*/

Rect rect1(30,  84, 278, 352);
Rect rect2(308, 84, 345, 436);
Rect rect3(653, 84, 278, 369);

Rect rect4(990, 84, 278, 201);
Rect rect5(1268, 84, 345, 436);
Rect rect6(1613, 84, 278, 201);

Rect rect7(1950, 84, 278, 361);
Rect rect8(2228, 84, 345, 487);
Rect rect9(2573, 84, 278, 378);

Rect rect10(2910, 84, 278, 302);
Rect rect11(3188, 84, 345, 453);
Rect rect12(3533, 84, 278, 243);
