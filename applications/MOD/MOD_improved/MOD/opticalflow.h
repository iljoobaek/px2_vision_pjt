...
extern float num_found;
extern float num_total;
extern float num_not_found;
/*
...
/*
 ...
 of interest.
 This simply computes the sum of the optical flow values of the points falling 
 ...
 error.
 This in turn calls drawrect() function where all the computations happen
 */
void findobst(Mat& flow, Mat& cflowmap, Mat& colnext, Mat& imsparse,vector<Point2f> *points,vector<uchar> &status,vector<float> err);
