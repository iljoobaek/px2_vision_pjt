...
#define debugimage 1
#define stop_early 0
#define stop_early_iterations 300
...
int main( int argc, char** argv )
{
    ...
    gpu::cvtColor(prv_temp_cap, prv_temp,CV_RGBA2BGR); 
    ...
    while(true)
    {
        ...
        gpu::cvtColor(next_temp_cap, next_temp,CV_RGBA2BGR); 
